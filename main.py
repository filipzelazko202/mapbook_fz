...
label_imie = Label(label_formularz, text="Imię: ")
label_nazwisko = Label(label_formularz, text="Nazwisko: ")
label_liczba_postow = Label(label_formularz, text="Liczba postow: ")
label_lokalizacja = Label(label_formularz, text="Lokalizacja: ")
...
label_szczegoly_obiektu = Label(ramka_szczegoly_obiektu, text="Sczegóły użytkownika")
...
label_liczba_postow_szczeoly_obiektu = Label(ramka_szczegoly_obiektu, text="Lokalizacja: ")
...
label_imie_szczegoly_obiektu_wartosc.grid(row=1, column=2)
label_nazwisko_szczegoly_obiektu.grid(row=1, column=3)
label_nazwisko_szczegoly_obiektu_wartosc.grid(row=1, column=4)
label_szczegoly_obiektu.grid(row=1, column=5)
label_imie_szczegoly_obiektu.grid(row=1, column=6)
label_lokalizacja_szczegoly_obiektu.grid(row=1, column=7)
label_szczegoly_obiektu.grid(row=1, column=8)
